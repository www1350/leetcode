...
public class P460Test {
    ...
    public void cacheForMoreTest(){
        ...
        cache.put(8,18);
        cache.put(1,7);
        Assert.assertEquals(cache.get(6),14);
        cache.put(9,29);
        cache.put(8,21);
        Assert.assertEquals(cache.get(5),18);
        cache.put(6,30);
        cache.put(1,12);
        Assert.assertEquals(cache.get(10),11);
        ...
        Assert.assertEquals(cache.get(1),12);Assert.assertEquals(cache.get(10),11);
        ...
        Assert.assertEquals(cache.get(4),29);

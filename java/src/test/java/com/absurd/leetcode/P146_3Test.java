 ...
 * @time 2018/2/3
 */
public class P146_3Test {
    @Test
    public void cacheTest(){
        LRUCache_3 cache = new LRUCache_3( 2 /* capacity */ );
    ...
    public void cacheForZeroTest(){
        LRUCache_3 cache = new LRUCache_3( 0 /* capacity */ );
        cache.put(0,0);
    ...
    public void cacheForOneTest(){
        LRUCache_3 cache = new LRUCache_3( 1 /* capacity */ );
        cache.put(2,1);
    ...
    public void cacheForMoreTest(){
        LRUCache_3 cache = new LRUCache_3( 10 /* capacity */ );
        cache.put(10,13);
        cache.put(3, 17);
        cache.put(6, 11);
        cache.put(10, 5);
